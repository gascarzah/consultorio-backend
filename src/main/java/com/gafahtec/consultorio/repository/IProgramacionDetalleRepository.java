...
""")
  ProgramacionDetalle existeProgramacionDetalle(@Param("idProgramacion")Integer idProgramacion, @Param("idEmpleado")Integer idEmpleado, @Param("numeroDia")Integer numeroDia);
}
