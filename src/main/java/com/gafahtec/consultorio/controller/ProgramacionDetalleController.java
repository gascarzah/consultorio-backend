...
public class ProgramacionDetalleController {
    ...
    public ResponseEntity<Set<ProgramacionDetalleResponse>> registrar(
        ...
        if (!iProgramacionDetalleService.existeProgramacionEmpleado(programacionDetalleRequest)) {
            throw new ResourceNotFoundException("El empleado "+ programacionDetalleRequest.getNumeroDocumento()+" ya tiene programacion");
        }
...
public ResponseEntity<Set<ProgramacionDetalleResponse>> listarDiasProgramados(@RequestParam("numeroDocumento") String numeroDocumento,
